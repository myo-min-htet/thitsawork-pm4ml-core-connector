...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2022-04-20T12:34:57.970747200+06:30[Asia/Rangoon]")public class TransferPartyInbound   {
  ...
  /**
   **/
  public TransferPartyInbound type(PayerType type) {
    this.type = type;
    return this;
  }
...
/**
   **/
  public TransferPartyInbound idType(IdType idType) {
    this.idType = idType;
    return this;
  }
...
/**
   ...
   **/
  public TransferPartyInbound idValue(String idValue) {
...
/**
   ...
   **/
  public TransferPartyInbound idSubValue(String idSubValue) {
...
/**
   **/
  public TransferPartyInbound displayName(String displayName) {
...
/**
   **/
  public TransferPartyInbound firstName(String firstName) {
...
/**
   **/
  public TransferPartyInbound middleName(String middleName) {
...
/**
   **/
  public TransferPartyInbound lastName(String lastName) {
...
/**
   ...
   **/
  public TransferPartyInbound dateOfBirth(String dateOfBirth) {
...
/**
   ...
   **/
  public TransferPartyInbound merchantClassificationCode(String merchantClassificationCode) {
...
/**
   ...
   **/
  public TransferPartyInbound fspId(String fspId) {
    this.fspId = fspId;
    return this;
  }
...
/**
   **/
  public TransferPartyInbound extensionList(List<ExtensionItem> extensionList) {
 ...
 @Size(min=0,max=16)  public List<ExtensionItem> getExtensionList() {
  ...
  public boolean equals(Object o) {
    ...
    TransferPartyInbound transferPartyInbound = (TransferPartyInbound) o;
    return Objects.equals(this.type, transferPartyInbound.type) &&
        Objects.equals(this.idType, transferPartyInbound.idType) &&
        Objects.equals(this.idValue, transferPartyInbound.idValue) &&
        Objects.equals(this.idSubValue, transferPartyInbound.idSubValue) &&
        Objects.equals(this.displayName, transferPartyInbound.displayName) &&
        Objects.equals(this.firstName, transferPartyInbound.firstName) &&
        Objects.equals(this.middleName, transferPartyInbound.middleName) &&
        Objects.equals(this.lastName, transferPartyInbound.lastName) &&
        Objects.equals(this.dateOfBirth, transferPartyInbound.dateOfBirth) &&
        Objects.equals(this.merchantClassificationCode, transferPartyInbound.merchantClassificationCode) &&
        Objects.equals(this.fspId, transferPartyInbound.fspId) &&
        Objects.equals(this.extensionList, transferPartyInbound.extensionList);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferPartyInbound {\n");
